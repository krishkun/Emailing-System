...
class AddEmpForm(forms.Form):
    ...
    oemail = forms.EmailField(label ='Official Email ID')
    ...
    domain = forms.ChoiceField(label='Domain',choices=Domain)
    ...
    sendVisCarReq = forms.BooleanField(label='Send Visiting Card Request', required = False)
    sendIdCarReq = forms.BooleanField(label='Send ID Card Request', required = False)
    sendPartCodeReq = forms.BooleanField(label='Send Partner Code Request', required = False)
    sendPanIndiaConf = forms.BooleanField(label='Send Pan India Confirmation', required = False)
    sendJoinWelcome = forms.BooleanField(label='Send New Hier Welcome', required = False)
